...
\end{tabular}
\tablecomments{ 
Percent addition to the map noise level $\Delta \sigma / \sigma$ by digitisation for white detector noise. Notice the invariance for each digitisation scheme with the number of hits per pixel and channel.
} \normalsize
\end{center}
\end{table*}
...
\end{tabular}
\tablecomments{ 
Percent addition to the map noise level $\Delta \sigma / \sigma$ by digitisation for $1/f$ detector noise. The invariance with depth of observation and channel as well as the values match the white noise case.
} \normalsize
\end{center}
\end{table*}
